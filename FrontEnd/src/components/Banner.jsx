...
import hostels from "../../public/hostelgreen.jpg"
...
function Banner() {
  return (
    ...
    <div> </div>
    <div className="max-w-screen-2x1  container mx-auto md:md:px-5 px-2 flex flex-col md:flex-row my-10">
...
<label className="input input-bordered flex items-center font-bold text-green-300 gap-2">
...
<button className="btn mt-6 btn-success btn-outline">Login</button>
   ...
   <div className="w-full md:w-1/2 mt-16 md:mt-40 ml-auto md:ml-2 lg:ml-auto text-center">
    <img src={hostels} className="inline-block w-96 h-72"></img>
</div>
